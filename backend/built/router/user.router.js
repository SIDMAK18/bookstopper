    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/];
            case 2: return [4 /*yield*/, user_model_1.UserModel.create(childdata_1.users)];
            case 3:
                _a.sent();
                res.send("Seed is done!");
                _a.label = 4;
            case 4:
                res.send(childdata_1.users);
                return [2 /*return*/];
        }
    });
}); }));
router.post("/login", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, BAD_REQUEST;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                if (user) {
                    res.status(httpstatus_1.HTTP_BAD_REQUEST)

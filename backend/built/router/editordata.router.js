...
var editordata_1 = require("../editordata");
var express_async_handler_1 = __importDefault(require("express-async-handler"));
var editdata_model_1 = require("../models/editdata.model");
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, editdata_model_1.editModel.countDocuments()];
            case 1:
                editcount = _a.sent();
                if (!(editcount > 0)) return [3 /*break*/, 2];
                res.send("Seed is already done!");
                return [2 /*return*/];
            case 2: return [4 /*yield*/, editdata_model_1.editModel.create(editordata_1.editBooks)];
            case 3:
                _a.sent();

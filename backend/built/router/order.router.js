        ...
        switch (_a.label) {
            case 0:
                ...
                if (requestOrder.items.length <= 0) {
                    res.send(httpstatus_1.HTTP_BAD_REQUEST).send('Cart is empty!');
                    return [2 /*return*/];
                }
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (order)
                    ...
                    res.status(httpstatus_1.HTTP_BAD_REQUEST).send();
                return [2 /*return*/];
        }
    });
}); }));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                order = _a.sent();
                if (!order) {
                    res.status(httpstatus_1.HTTP_BAD_REQUEST).send('Order Not Found!');
                    return [2 /*return*/];
                }
                order.paymentId = paymentId;
                order.status = orderstatus_1.OrderStatus.PAYED;
...
function getNewOrderForCurrentUser(req) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, order_model_1.OrderModel.findOne({ user: req.user.id, status: orderstatus_1.OrderStatus.NEW })];

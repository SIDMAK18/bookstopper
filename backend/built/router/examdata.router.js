...
var exambookdata_1 = require("../exambookdata");
var express_async_handler_1 = __importDefault(require("express-async-handler"));
var examdata_model_1 = require("../models/examdata.model");
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, examdata_model_1.examModel.countDocuments()];
            case 1:
                examcount = _a.sent();
                if (!(examcount > 0)) return [3 /*break*/, 2];
                res.send("Seed is already done!");
                return [2 /*return*/];
            case 2: return [4 /*yield*/, examdata_model_1.examModel.create(exambookdata_1.examBooks)];
            case 3:
                _a.sent();

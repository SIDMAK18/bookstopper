...
var childdata_1 = require("../childdata");
var express_async_handler_1 = __importDefault(require("express-async-handler"));
var childdata_model_1 = require("../models/childdata.model");
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, childdata_model_1.childModel.countDocuments()];
            case 1:
                childcount = _a.sent();
                if (!(childcount > 0)) return [3 /*break*/, 2];
                res.send("Seed is already done!");
                return [2 /*return*/];
            case 2: return [4 /*yield*/, childdata_model_1.childModel.create(childdata_1.childBooks)];
            case 3:
                _a.sent();

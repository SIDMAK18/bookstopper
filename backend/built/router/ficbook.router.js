...
var ficdata_1 = require("../ficdata");
var express_async_handler_1 = __importDefault(require("express-async-handler"));
var ficdata_model_1 = require("../models/ficdata.model");
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ficdata_model_1.ficModel.countDocuments()];
            case 1:
                ficcount = _a.sent();
                if (!(ficcount > 0)) return [3 /*break*/, 2];
                res.send("Seed is already done!");
                return [2 /*return*/];
            case 2: return [4 /*yield*/, ficdata_model_1.ficModel.create(ficdata_1.ficBooks)];
            case 3:
                _a.sent();

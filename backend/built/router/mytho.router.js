...
var mythologydata_1 = require("../mythologydata");
var express_async_handler_1 = __importDefault(require("express-async-handler"));
var mythdata_model_1 = require("../models/mythdata.model");
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mythdata_model_1.mythModel.countDocuments()];
            case 1:
                mythcount = _a.sent();
                if (!(mythcount > 0)) return [3 /*break*/, 2];
                res.send("Seed is already done!");
                return [2 /*return*/];
            case 2: return [4 /*yield*/, mythdata_model_1.mythModel.create(mythologydata_1.mythoBooks)];
            case 3:
                _a.sent();
